...
Route::get('/snaptoke ', 'SnapController@token');
Route::get('/bayar', 'BayarController@index')->name('welcome');
Route::post('/finish', function(){
    return redirect()->route('welcome');
})->name('bayar.finish');

Route::post('/bayar/store', 'BayarController@submitBayar')->name('bayar.store');
Route::post('/notification/handler', 'BayarController@notificationHandler')->name('notification.handler');
