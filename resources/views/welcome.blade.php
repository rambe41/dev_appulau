    ...
    <div class="container">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        <label class="control-label" for="donor_name">Nama</label>
                        <div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <input id="donation_type" name="donation_type" type="text" placeholder="Enter your type" class="form-control input-md"
                                required="">
                        </div>
                    </div>
        ...
        <table class="table table-striped" id="list">
            ...
            <tr>
                ...
                <td>{{ $bayar->donor_name }}</td>
                <td>Rp. {{ number_format($bayar->amount) }},-</td>
                <td>{{ ucwords(str_replace('_', ' ', $bayar->donation_type)) }}</td>
